...
export default function RegisterDetail1() {
  ...
  const handleNext = () => {
    ...
    if (!cnpj || !cpf || !birthDate || !phone || !email) {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>CPF do representante legal*</Text>
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Data de nascimento do representante legal*</Text>
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Celular do representante legal*</Text>
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>E-mail do representante legal*</Text>
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.input}
