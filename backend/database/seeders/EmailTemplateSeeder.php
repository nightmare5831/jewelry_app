    ...
    public function run(): void
    {
        $templates = [
            [
                ...
                'subject' => 'Bem-vindo à Fala Shop!',
                'body_html' => '<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Bem-vindo à Fala Shop</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2>Olá, {{userName}}!</h2>
            <p>Seja muito bem-vindo(a) à <strong>Fala Shop</strong>, sua nova loja de joias online!</p>
            ...
            <div class="features">
                <h3>O que você pode fazer na Fala Shop:</h3>
                <ul>
            ...
            <p>Com carinho,<br><strong>Equipe Fala Shop</strong></p>
        </div>
        <div class="footer">
            <p><strong>Fala Shop</strong></p>
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #999999;">
                Você está recebendo este email porque criou uma conta na Fala Shop.
            </p>
        </div>
    </div>
</body>
            ...
            [
                ...
                'body_html' => '<p><strong>Olá {{userName}}!</strong></p><p>Seu pedido <strong>#{{orderNumber}}</strong> foi confirmado com sucesso!</p><p>Valor total: <strong>{{totalAmount}}</strong></p><p>Obrigado por comprar na Fala Shop!</p>',
